...
export const countryToContinent: { [key: string]: string } = {
    ...
    CY: 'Asia',         // Cyprus (Geopolitical: Asia)
    CZ: 'Europe',       // Czechia
    DE: 'Europe',       // Germany
    DJ: 'Africa',       // Djibouti
    DK: 'Europe',       // Denmark
    ...
    GE: 'Asia',         // Georgia (Geopolitical: Asia)
    ...
    RO: 'Europe',       // Romania
    RS: 'Europe',       // Serbia
    RU: 'Europe',       // Russia (Primary: Europe)
    RW: 'Africa',       // Rwanda
    ...
    TN: 'Africa',       // Tunisia
    TO: 'Oceania',      // Tonga
    TR: 'Asia',         // Turkey (Geopolitical: Asia)
  ...
  // Optional: TypeScript type for stricter usage
  export type CountryCode = keyof typeof countryToContinent;