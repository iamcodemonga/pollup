            ...
            <body className={`${geistSans.variable} ${geistMono.variable} antialiased`} >
                <ThemeProvider attribute={"class"} defaultTheme="system" enableSystem>
                    <section className='w-full flex h-screen'>
                        <aside className='fixed top-0 left-0 bg-background border- border-gray-300 h-full w-14 flex flex-col justify-between pb-10'>
                            <div className='h-full w-full pb-5 pt-5 space-y-7'>
                                <Link href={"/dashboard"} className='flex flex-col justify-center items-center text-primary'>
                                ...
                                <Link href={"/dashboard/polls"} className='flex flex-col justify-center items-center text-slate-600 dark:text-slate-500'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 mb-1">
                                ...
                                <Link href={"/dashboard/votes"} className='flex flex-col justify-center items-center text-slate-600 dark:text-slate-500'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 mb-1">
                                ...
                                <Link href={"/dashboard/settings"} className='flex flex-col justify-center items-center text-slate-600 dark:text-slate-500'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 mb-1">
