    ...
    return (
        <main className='w-full relative overflow-x-hidden ml-14 pr-4 lg:pl-3 overview'>
            ...
            <div className='grid grid-cols-12 gap-x-3 gap-y-3 lg:gap-y-0 lg:gap-x-3'>
                <TopCard label='total revenue' value={200} money={true} index={0}>
                ...
                <TopCard label="polls" value={15} money={false}>
                    <div className='rounded-2xl p-3 bg-sky-500/10 flex justify-center items-center w-14 h-14'>
                ...
                <TopCard label='votes' value={20} money={false}>
                    <div className='rounded-2xl p-3 bg-sky-500/10 flex justify-center items-center w-14 h-14'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-sky-500">
                ...
                <TopCard label='questionaires' value={200} money={false}>
                    <div className='rounded-2xl p-3 bg-sky-500/10 flex justify-center items-center w-14 h-14'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-sky-500">
            ...
            <section className='w-full py-10 allorders-section hidde'>
                <h3 className='text-xl mb-3 text-center lg:text-left'>Recent Polls</h3>
