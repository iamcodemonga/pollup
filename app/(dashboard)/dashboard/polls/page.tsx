...
const page = () => {
    return (
        <main className='w-full relative overflow-x-hidden ml-14 pr-4 lg:pl-3 allpolls'>
            <div className='flex w-full pr-2 py-5 mt-7'>
                <h1 className='text-2xl'>Created Polls</h1>
            </div>
            <section className='w-full pb-10 allorders-section hidde'>
