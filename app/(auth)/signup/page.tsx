    ...
    return (
        <div className='w-full lg:flex'>
            ...
            <div className='h-screen w-full flex justify-center items-center bggg'>
                <form className='borde py- px-5 w-80  space-y-7 rounded-lg'>
                    <div>
                        <h1 className='text-center text-xl text-sky-500 mb-2'>Create Account</h1>
                        <p className='text-center text-gray-500 text-sm'>Make decisions, earn rewards 👍 </p>
                    </div>
                    <div className='space-y-5'>
                        <div>
                            <label htmlFor="fullname" className='block text-xs text-gray-500 mb-1 ml-1'>Fullname</label>
                        ...
                        <div>
                            <label htmlFor="username" className='block text-xs text-gray-500 mb-1 ml-1'>Username</label>
                    ...
                    <div className='w-full flex justify-center'>
                        <div className='w-full space-y-4'>
                            <div className="flex items-center space-x-2 ml-1">
                                ...
                                <label htmlFor="terms" className='block text-xs text-gray-500'>I agree with all the <Link href={'/'} className='underline text-blue-700'>terms and conditions</Link></label>
                            </div>
                            <button type='submit' className='w-full py-3 px-10 text-white rounded-lg bg-black text-sm'>submit</button>
                            <small className='block text-gray-500 text-center text-xs'>Already have an account? <Link href={"/login"} className='underline text-blue-700'>Login</Link></small>
                        </div>
                    </div>
                </form>
            </div>
