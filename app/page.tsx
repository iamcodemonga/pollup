      ...
      <section className="w-full px-3 lg:px-20">
        <div className="w-full flex justify-center mt-52 lg:mt-60">
          <div className="w-full lg:w-3/5 px-0 lg:px-0 flex flex-col justify-center items-center">
            <BlurFade direction="up" inView>
              <h1 className="font-semibold text-3xl lg:text-5xl !leading-[1.2] text-center capitalize">The Smarter Way to Test Ideas: Get Feedback, Emails & Pre-Orders—Without Building a Thing</h1>
            ...
            <div className="w-full flex justify-center">
              <BlurFade direction="up" delay={0.25} inView>
                <p className="text-center text-foreground/80 mt-7 w-full lg:w-[500px]">Validate your next big idea in minutes—not months. Use interactive polls to gather real feedback, grow your email list, and even secure pre-orders—all before writing a single line of code or spending on prototypes.</p>
              </BlurFade>
            </div>
            <div className="w-full flex justify-center mt-7 space-x-3">
              <Link href="/signup" className="flex justify-between items-center space-x-10 px-5 py-3 text-background bg-primary border border-primary rounded-full text-[12px]"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 mr-1">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                </svg>Create free account
              </Link>
              <Link href={user?.id ? "/create" : "/create"} className="flex justify-between items-center space-x-10 px-5 py-3 bg-transparent text-foreground rounded-full text-[12px] border border-foreground">{user?.id ? "Test Your Idea Now " : "Test Your Idea Now "}<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 ml-2">
        ...
        <div className="w-full flex justify-center mt-20 lg:mt-16">
          <div className="flex flex-col justify-center items-center">
            ...
            <h3 className="capitalize text-base font-bol text-foreground/70 text-center px-5">Trusted by over <strong className="text-primary">20+</strong> businesses worldwide</h3>
            <div className="hidden lg:flex space-x-8 items-center mt-10">
              <div>
                <h2 className="text-center text-5xl font-bold text-primary">
                  <NumberTicker value={20} className="!text-primary" style={{letterSpacing: .5}} />+
                </h2>
                <p className="text-center text-sm text-foreground/80">Businesses</p>
              </div>
              <Separator orientation="vertical" className="h-36" />
              <div>
                <h2 className="text-center text-5xl font-bold text-primary">
                  <NumberTicker value={500} className="!text-primary" style={{letterSpacing: .5}} />+
                </h2>
                <p className="text-center text-sm text-foreground/80">Smart Polls</p>
              </div>
            ...
            <div className="lg:hidden space-y-4 mt-10">
              <div>
                <h2 className="text-center text-3xl font-bold text-primary"><NumberTicker value={20} className="!text-primary" style={{letterSpacing: .5}} />+</h2>
                <p className="text-center text-sm text-foreground/80">Businesses</p>
              </div>
              <Separator orientation="horizontal" className="w-60" />
              <div>
                <h2 className="text-center text-3xl font-bold text-primary"><NumberTicker value={500} className="!text-primary" style={{letterSpacing: .5}} />+</h2>
                <p className="text-center text-sm text-foreground/80">Smart Polls</p>
              </div>
      ...
      <section className="w-full px-3 lg:px-20">
        <div className="w-full grid grid-cols-2 mt-28 gap-y-28 gap-x-12 items-center">
          <div className="col-span-2 lg:col-span-1 w-full">
            ...
            <LandingPollFetcher id={`${process.env.SPECIAL_POLL}`} />
          </div>
      ...
      <section className="w-full">
        <div className="flex justify-center mt-40 lg:mt-52">
          <div className="lg:w-3/4 w-full px-5 lg:px-0">
            ...
            <div className="w-full flex justify-center">
              <p className="text-center text-foreground/80 mt-7 w-[600px]">Don’t just take our word for it. Hear from thousands of users who’ve gained useful insights for their business. Join the community that’s changing how polls work!</p>
            </div>
          </div>
        </div>
        <TwitterTestimonials />
        ...
        <div className="flex justify-center mt-16">
            <div className="w-full bg-secondary flex justify-center py-40 lg:py-48 lg:rounded-2x">
              <div className="w-full lg:w-2/3">
                <h2 className="text-center text-2xl lg:text-5xl text-black px-3 !leading-normal capitalize">Get valuable demographics and actionable insights from your potential customers.</h2>
